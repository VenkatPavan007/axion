...
module.exports = class ManagersLoader {
    ...
    load() {
        ...
        this.managers.school              = new SchoolManager({ config: this.config, managers: this.managers, validators: this.validators });
        this.managers.user                = new UserManager({ config: this.config, managers: this.managers, validators: this.validators });
        this.managers.classroom           = new ClassroomManager({ config: this.config, managers: this.managers, validators: this.validators });
        this.managers.student             = new StudentManager({ config: this.config, managers: this.managers, validators: this.validators });
        /*************************************************************************************************/
